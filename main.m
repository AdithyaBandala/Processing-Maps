...
legend(Scatter,'300°C','350°C','400°C','450°C','500°C','550°C','Location','southeast','FontSize',15);
hold off
...
%% Fit: 'untitled fit 2'.
[xData, yData, zData] = prepareSurfaceData( T, 
strainlog, iz );
% Set up fittype and options.
ft = fittype( 'poly45' );
% Fit model to data.
...
fusionimage=imfuse(fig1,fig2,'falsecolor','Scaling','joi
nt');
